...
Козир із GSM-модулем: «Для кооперативів ми категорично не рекомендуємо купувати пульти на кожну машину — це десятки тисяч гривень на вітер. Краще вибрати опцію "Управління зі смартфона (Wi-Fi/GSM)", яка у нас на сайті коштує всього 1500 грн. Ми комплектуємо систему надійним GSM-модулем (серії Prosto Dzvinok тощо). Ви вставляєте туди SIM-карту, і мешканці відкривають ворота безкоштовним дзвінком зі смартфона, а ви легко керуєте базою номерів. Для великих ОСББ/кооперативів ми підберемо контролер індивідуально під вашу кількість людей».
